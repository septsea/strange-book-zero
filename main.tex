...
\begin{center}
    \textbf{\LARGE Delving into Polynomials}

    \vspace{1.5ex}

    \textit{A \ding{180}\myFN{\ding{180} implies stupidity in the two-dimensional culture.} article written by a \ding{180} person}
\end{center}
