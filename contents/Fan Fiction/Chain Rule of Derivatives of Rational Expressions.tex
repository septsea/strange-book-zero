\subsection*{\ChainRuleOfDerivativesOfRationalExpressions}
\addcontentsline{toc}{subsection}{\ChainRuleOfDerivativesOfRationalExpressions}
\markright{\ChainRuleOfDerivativesOfRationalExpressions}

本文介绍有理式的微商的链规则 \term{the chain rule}.
