...
\begin{definition}
    设 $f$, $g$ 是整数\period 若存在整数 $h$ 使 $f=gh$, 则说 $g$ 是 $f$ 的因子 \term{factor}\period
\end{definition}
...
\begin{definition}
    设 $f$, $g$ 是整数\period 若 $d$ 是 $f$ 的因子, 且 $d$ 是 $g$ 的因子, 则 $d$ 是 $f$ 与 $g$ 的公因子 \term{common factor}\period
\end{definition}
...
\begin{definition}
    设 $f$, $g$ 是整数\period 适合下述二性质的整数 $d$ 是 $f$ 与 $g$ 的最大公因子 \term{greatest common factor}:
