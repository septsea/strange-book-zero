...
\begin{example}
    ...
    \end{align*}
    这表明: 多项式的复合一般不交换\period
\end{example}

下面的命题相当显然了\period

\begin{proposition}
    设 $f(x)$, $g(x)$, $h(x) \in D[x]$\period
...
\begin{pf}
    ...
    \begin{align*}
         ...
         & g(x) = b_0 + b_1 x + \cdots + b_n x^n
    \end{align*}
    是 $D[x]$ 中二个元\period 这样,
    \begin{align*}
         & f(h(x)) = a_0 + a_1 h(x) + \cdots + a_n (h(x))^n,        \\
         & g(h(x)) = b_0 + b_1 h(x) + \cdots + b_n (h(x))^n \period
    \end{align*}
    ...
    其中
    \begin{align*}
        c_i = a_i + b_i, \quad i = 0,1,\cdots,n \period
    \end{align*}
    所以
    \begin{align*}
        p(h(x)) = c_0 + c_1 h(x) + \cdots + c_n (h(x))^n \period
    \end{align*}
    根据多项式的运算律, 有
    \begin{align*}
             & f(h(x)) + g(h(x))                                                                   \\
    ...
    其中
    \begin{align*}
        d_i = a_0 b_i + a_1 b_{i-1} + \cdots + a_i b_0, \quad i = 0,1,\cdots,2n \period
    \end{align*}
    所以
    \begin{align*}
        q(h(x)) = d_0 + d_1 h(x) + \cdots + d_{2n} (h(x))^{2n} \period
    \end{align*}
    根据多项式的运算律, 有
    \begin{align*}
             & f(h(x)) g(h(x))                                                                               \\
