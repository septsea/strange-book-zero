...
\begin{example}
    ...
    不同的老婆\myFN{一般地, 二次元人会称动画、漫画、游戏、小说中自己喜爱的女性角色为老婆 \term{waifu}\period 一个二次元人可以有不止一个老婆\period}有着不同的发色\period 但是, 我们用数学归纳法却可以证明, 任意的 $n$ ($n \geq 1$) 个老婆有着相同的发色! 称这个命题为 $Q(n)$\period 这里, $n_0$ 自然取 $1$\period
...
下面是数学归纳法的一个变体\period 这也叫数学归纳法\period
