...
\begin{proposition}
    设 $n$ 是非负整数. 设 $f(x)$ 是次不高于 $n$ 的整式. 设 $c \in \mathbb{F}$. 则 Taylor 公式 \term{Taylor\apostrophe s formula} 成立:
    \begin{align*}
...
\begin{remark}
    事实上, 我们得到了高级流数的 Leibniz 公式 \term{Leibniz\apostrophe s formula}: 若 $k$ 是非负整数, 且 $f(x)$, $g(x) \in \mathbb{F}[x]$, 则
    \begin{align*}
