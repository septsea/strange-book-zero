...
本节讨论多项式的微分学 \term{differential calculus} 初步\myFN{学过一元函数微分学的读者可能会觉得本节废话连篇. 不过, 为照顾不熟悉三角不等式及相关知识的读者, 作者也没什么更好的写作思路了.}. 这也是本文的最终节.
...
之前, 微商都是形式的——有点 ``空降'' 的味道. 现在, 我们要用 Taylor 公式给微商一种含义. 如果您知道一点微积分 \term{calculus}, 您将不会对本节感到特别陌生; 如果您没有学过微积分, 无妨将本节作为 ``入微作''.
